...
def thumbnailVideo(theInputVideo, theOutputVideo, theBlockWidth, theBlockHeight):
    ...
    ffmpegLine = "ffmpeg -hide_banner -loglevel error -y -i \"" + theInputVideo + "\" -vf \"scale=" + str(scaledWidth) + ":" + str(scaledHeight) + ",pad=" + str(resultWidth) + ":" + str(resultHeight) + ":" + str(pasteX) + ":" + str(pasteY) + ":#FFFFFF@1,format=rgb24\" -vcodec x264 -crf 18 \"" + theOutputVideo + "\" 2>&1"
    print(ffmpegLine)

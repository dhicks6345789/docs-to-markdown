...
shutil.copytree(".." + os.sep + ".." + os.sep + "assets" + os.sep + "bootstrap", args["output"] + os.sep + "bootstrap")
shutil.copytree(".." + os.sep + ".." + os.sep + "assets" + os.sep + "bootstrap-icons", args["output"] + os.sep + "bootstrap-icons")
